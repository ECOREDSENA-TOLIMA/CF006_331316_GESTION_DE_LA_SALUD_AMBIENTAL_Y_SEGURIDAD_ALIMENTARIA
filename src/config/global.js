  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        subMenu: [
          {
            numero: '1.1',
            titulo: 'Principios de participación y responsabilidad social',
            hash: 't_1_1',
          },
          {
            numero: '1.2',
            titulo: 'Mecanismos democráticos y de participación social',
            hash: 't_1_2',
          },
          {
            numero: '1.3',
            titulo: 'Promover el empoderamiento y la gobernanza',
            hash: 't_1_3',
          },
        ],
      },

      {
        nombreRuta: 'tema2',
        numero: '2',
        titulo: 'Planeación en el desarrollo de las actividades',
        desarrolloContenidos: true,
        subMenu: [
          {
            numero: '2.1',
          ...
          },
          {
            numero: '2.2',
            titulo:
              'Sistematizar las experiencias obtenidas en los mecanismos de participación social',
            hash: 't_2_2',
          },
          {
            numero: '2.3',
            titulo:
              'Divulgar las estrategias definidas para favorecer la participación social y la gobernanza',
            hash: 't_2_3',
          },
        ],
      },
    ...
    subMenu: [
      ...
      },
      {
        ...
        download: 'downloads/CFA_06_331316.zip',
      },
      {
        icono: 'fas fa-download',
